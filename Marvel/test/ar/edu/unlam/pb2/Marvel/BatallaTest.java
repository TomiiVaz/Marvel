...
public class BatallaTest {
	...
	public void elHeroeResultaVencedorEnLaBatalla() throws PoderesEmpateException {
		...
		assertEquals(thor, batalla.generarCombate(thor, loki));
	}
	...
	public void elResultadoDeLaBatallaEsUnEmpate() throws PoderesEmpateException {
		...
		batalla.generarCombate(thor, loki);
	}
	...
	public void elVillanoAumentaElPoderYGanaLaBatalla()
		...
		loki.aumentarPoder();
		assertEquals(loki, batalla.generarCombate(thor, loki));
	}
	...
	public void ordenarListaDeVillanosDescendente() throws PoderesEmpateException, NoAumentaPoderException,
		...
		batalla.generarCombate(thor, loki);
		batalla.generarCombate(capitanAmerica, ronnan);
		batalla.generarCombate(hulk, redSkull);
		batalla.generarCombate(blackWidow, soldadoDeInvierno);
		batalla.generarCombate(ironMan, hela);
	...
	@Test(expected = CollectionNullException.class)
	public void laColeccionDeHeroesEstaVacia() throws CollectionNullException {
		Batalla batalla = new Batalla();
	...
	public void noSePuedeSalvarElMundo() throws NoAumentaPoderException, LaGemaNoAumentaPoderException, PoderesEmpateException, WorldDestroyedException {
		Batalla batalla = new Batalla();
		...
		Avenger thor = new Heroe("Thor", 10, mente);
		Avenger capitanAmerica = new Heroe("Capitan America", 11);
		Avenger hulk = new Heroe("Hulk", 10, realidad);
		Avenger blackWidow = new Heroe("Black Widow", 10);
		Avenger ironMan = new Heroe("Iron Man", 11, espacio);

		Avenger loki = new Villano("Loki", 150);
		Avenger ronnan = new Villano("Ronnan", 90, tiempo);
		Avenger redSkull = new Villano("Red Skull", 80, alma);
		Avenger soldadoDeInvierno = new Villano("Soldado De Invierno", 50);
		Avenger hela = new Villano("Hela", 90, poder);
